...
Para cualquier cambio no trivial con riesgo de contrato, estado remoto, formulario, overlay, componente compartido o autorización, leer antes `.claude/skills/pr-readiness/SKILL.md` y emitir su reporte de preflight. Aplicar únicamente las categorías activadas por el diff. No sustituir esta preparación observable por razonamiento interno ni por una lista genérica de componentes.
