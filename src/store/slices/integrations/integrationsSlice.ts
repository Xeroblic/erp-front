...
export const fetchIntegrations = createAsyncThunk(
    ...
    async (
        ...
        try {
            ...
            return rejectWithValue(error.response?.data?.message || 'Error al cargar integraciones');
        }
    },
);
...
export const deleteIntegration = createAsyncThunk(
    ...
    async (
        ...
        try {
            ...
            return rejectWithValue(error.response?.data?.message || 'Error al eliminar integración');
        }
    },
);
