...
export const selectBatches = (state: RootState): IBatch[] => state.technicalReviews.batches;

export const selectBatchesMeta = (state: RootState): ListMeta => state.technicalReviews.batchesMeta;
...
export const selectTechnicalReviewsContextSubsidiaryId = (state: RootState): number | null =>
	state.technicalReviews.contextSubsidiaryId;

// ====================================================================
// SERIES/ITEMS
// ====================================================================

export const selectItems = (state: RootState): IItem[] => state.technicalReviews.items;

export const selectItemsMeta = (state: RootState): ListMeta => state.technicalReviews.itemsMeta;
...
export const selectCreating = (state: RootState): boolean => state.technicalReviews.creating;

export const selectUpdating = (state: RootState): boolean => state.technicalReviews.updating;

export const selectDeleting = (state: RootState): boolean => state.technicalReviews.deleting;
...
export const selectApproving = (state: RootState): boolean => state.technicalReviews.approving;
