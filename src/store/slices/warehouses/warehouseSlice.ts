    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchWarehouseDetail.rejected, (state, action) => {
                state.warehouseDetailLoading = false;
                state.warehouseDetailError = action.payload ?? 'No se pudo obtener el detalle de la bodega';
            })
            ...
            .addCase(detachWarehouseProduct.rejected, (state, action) => {
                state.detachingProduct = false;
                state.warehouseDetailError = action.payload ?? 'No se pudo quitar el producto de la bodega';
            });
    },
});
