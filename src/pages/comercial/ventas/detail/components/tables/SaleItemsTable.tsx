                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className='flex flex-col gap-1'>
                            ...
                            {row.original.serial_numbers && row.original.serial_numbers.length > 0 && (
                                <div className='mt-1 flex flex-wrap gap-1'>
                                    {row.original.serial_numbers.map((sn) => (
                                        <span
                                            key={sn}
                                            className='text-[10px] bg-zinc-100 px-1.5 py-0.5 text-zinc-600 dark:bg-zinc-800 dark:text-zinc-300 rounded border border-zinc-200 dark:border-zinc-700'>
                                            {sn}
                                        </span>
                                    ))}
                                </div>
