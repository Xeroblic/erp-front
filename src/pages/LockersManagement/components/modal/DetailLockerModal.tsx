...
const DetailLockerModal: React.FC<IDetailLockerModalProps> = ({ isOpen, detailLocker, onClose, serviceOrders }) => {
            ...
            <ModalBody>
                <div className='space-y-4'>
                    ...
                    <div className='rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800'>
                        <h4 className='mb-3 text-sm font-semibold text-zinc-700 dark:text-zinc-300'>Información del Casillero</h4>
                            ...
                            <DetailRow
                                ...
                                value={
                                    order?.checked_in_at || detailLocker.check_in_at
                                        ? new Date(order?.checked_in_at || detailLocker.check_in_at!).toLocaleString('es-CL')
                                        : '—'
                                }
                            />
                        </div>
                    ...
                    <div className='rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800'>
                        <h4 className='mb-3 text-sm font-semibold text-zinc-700 dark:text-zinc-300'>Datos del Cliente</h4>
                        <div className='grid grid-cols-2 gap-x-6 gap-y-2 text-sm'>
                    ...
                    <div className='rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800'>
                        <h4 className='mb-3 text-sm font-semibold text-zinc-700 dark:text-zinc-300'>Datos del Equipo</h4>
                        <div className='grid grid-cols-2 gap-x-6 gap-y-2 text-sm'>
