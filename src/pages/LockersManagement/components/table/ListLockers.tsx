    ...
    const columns = useMemo(() => [
        ...
        columnHelper.display({
            ...
            cell: (info) => {
                ...
                return (
                    <div>
                        <p className='font-medium text-zinc-800 dark:text-zinc-200'>{clientName}</p>
        ...
        columnHelper.display({
            ...
            cell: (info) => {
                ...
                return (
                    <div className='max-w-[180px] truncate text-zinc-600 dark:text-zinc-400' title={deviceInfo}>
                        {deviceInfo}
                    </div>
                );
            },
        ...
        columnHelper.display({
            ...
            cell: (info) => {
                const locker = info.row.original;
                const order = locker.active_service_order || orderByLockerId[locker.id];
                const checkInDate = order?.checked_in_at || locker.check_in_at || order?.created_at;
                return (
