...
const Perfil = () => {
			...
			provincia: Yup.string()
				...
				.test(
					...
					function (value) {
						...
						return provincia ? provincia.codigo_padre === regionCodigo : false;
					},
				),
			comuna: Yup.string()
				.nullable()
				.test(
					...
					function (value) {
						...
						return comuna ? comuna.codigo_padre === provinciaCodigo : false;
					},
				),
		}),
		onSubmit: async (vals) => {
	...
	useEffect(() => {
		...
		const filtered = listaComunas.filter(
			(c) =>
