...
const Dashboard: React.FC = () => {
    ...
    return (
        <PageWrapper isProtectedRoute={false} className='bg-gray-50 dark:bg-gray-900' name='Dashboard EcoPC'>
            {/* Encabezado */}
            <Subheader>
                <SubheaderLeft>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                                <div>
                                    ...
                                    <p className="text-emerald-100 mb-4">
                                        Gestiona tu inventario de manera eficiente con datos en tiempo real
                                    </p>
                                    <div className="flex space-x-3">
                                        <Button
                                            variant="outline"
                                            className="border-white text-white hover:bg-white hover:text-emerald-600"
                                            onClick={() => alert('¡Dashboard funcionando perfectamente! 🎉')}
                                        >
                                            ✅ Todo Funciona
                                        </Button>
                                        <Button
                                ...
                                <div className="text-center">
                                    <div className="bg-white/10 rounded-lg p-4">
                                        <h3 className="text-lg font-bold mb-2">📊 Resumen Rápido</h3>
                                        <div className="grid grid-cols-2 gap-2 text-sm">
                                            <div>💰 Inventario: $2.9M</div>
                                            <div>📦 7 Productos</div>
                                            <div>⚠️ 4 Stock Bajo</div>
