...
const LatestSalesTimeline: React.FC<Props> = () => {
    ...
    return (
        <Card className='h-full border border-zinc-200 shadow-sm dark:border-zinc-800 bg-white dark:bg-zinc-900'>
            <CardHeader className='flex items-center justify-between border-b border-zinc-100 px-6 py-4 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50'>
                            ...
                            return (
                             <div key={sale.id} className="group relative flex gap-4">
                                ...
                                <div className="relative z-10 flex flex-col items-center">
                                    <div className="h-10 w-10 rounded-full flex items-center justify-center bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400 ring-4 ring-white dark:ring-zinc-900 mt-1">
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                                        <div className="flex flex-col gap-1 min-w-0 flex-1">
                                            ...
                                            <div className="flex items-center gap-2 text-xs">
                                                <span className="font-mono text-zinc-400">ID: {sale.sale_number}</span>
                                                <Badge 
                                                    variant='outline' 
                                                    color='emerald'
                                        ...
                                        <div className="flex flex-row sm:flex-col items-center sm:items-end gap-3 sm:gap-1 mt-2 sm:mt-0">
                                            ...
                                            <Button
                                                ...
                                                variant='outline'
                                                color='zinc'
                                                className='h-7 px-3 text-[10px] font-medium w-full sm:w-auto'
                                                onClick={() => dispatch(downloadShippingLabel({ subsidiaryId: Number(subsidiaryId), id: sale.id }))}
                                            >
                                                <Icon icon='HeroArrowDownTray' className='mr-1.5 h-3.5 w-3.5' />
                                                Etiqueta
                                            </Button>
                                        </div>
                                    </div>
