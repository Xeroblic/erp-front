...
const EcoTIDashboard: React.FC = () => {
	...
	const getTrendIcon = (trend: string) => {
		switch (trend) {
			case 'up':
				return 'HeroArrowTrendingUp';
			case 'down':
				return 'HeroArrowTrendingDown';
			case 'stable':
				return 'HeroMinus';
			default:
				return 'HeroMinus';
		...
		<div className='space-y-6 py-6'>
					...
					<CardBody className='p-6'>
						<div className='flex items-center justify-between'>
							...
							<div className='rounded-lg bg-white/20 p-3'>
								<Icon icon='HeroRocketLaunch' className='h-8 w-8 text-white' />
							</div>
						</div>
					</CardBody>
				</Card>
				...
				<Card className='bg-gradient-to-br from-blue-600 to-indigo-600 text-white shadow-lg'>
					<CardBody className='p-6'>
						<div className='flex items-center justify-between'>
							...
							<div className='rounded-lg bg-white/20 p-3'>
								<Icon icon='HeroChartBarSquare' className='h-8 w-8 text-white' />
							</div>
						</div>
					</CardBody>
				</Card>
				...
				<Card className='bg-gradient-to-br from-indigo-500 to-blue-500 text-white shadow-lg'>
					<CardBody className='p-6'>
						<div className='flex items-center justify-between'>
							...
							<div className='rounded-lg bg-white/20 p-3'>
								<Icon icon='HeroServerStack' className='h-8 w-8 text-white' />
							</div>
						</div>
					</CardBody>
				</Card>
			...
			<div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
				...
				<Card className='col-span-1 shadow-lg'>
					<CardHeader className='rounded-t-xl bg-gradient-to-r from-blue-500 to-blue-600 text-white'>
						<div className='flex items-center justify-between'>
							<h3 className='flex items-center text-lg font-semibold'>
								<Icon icon='HeroRocketLaunch' className='mr-2 h-5 w-5' />
								Servicios Activos
							</h3>
					...
					<CardBody className='max-h-96 overflow-y-auto p-0'>
						{loading ? (
							<div className='p-6 text-center'>
								<Icon
									icon='HeroArrowPath'
									className='mx-auto mb-2 h-6 w-6 animate-spin text-blue-500'
								/>
									...
									<div className='space-y-2'>
										<div className='flex items-start justify-between'>
											...
											<div className='ml-4 text-right'>
												<Badge
													className={`${getPriorityColor(service.priority)} text-xs font-semibold`}>
													{service.priority}
												</Badge>
											</div>
										</div>
				...
				{/* Métricas Técnicas */}
				<Card className='col-span-1 shadow-lg'>
					<CardHeader className='rounded-t-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white'>
						<div className='flex items-center justify-between'>
							<h3 className='flex items-center text-lg font-semibold'>
								<Icon icon='HeroChartBarSquare' className='mr-2 h-5 w-5' />
								Métricas Técnicas
							</h3>
							<Badge className='bg-white/20 font-semibold text-white'>Live</Badge>
						</div>
					</CardHeader>
					<CardBody className='max-h-96 overflow-y-auto p-0'>
						{loading ? (
				...
				<Card className='col-span-1 shadow-lg'>
					<CardHeader className='rounded-t-xl bg-gradient-to-r from-blue-700 to-blue-800 text-white'>
						<h3 className='flex items-center text-lg font-semibold'>
					...
					<CardBody className='space-y-4 p-4'>
							...
							<div className='space-y-1 text-xs'>
								<div className='flex justify-between'>
									<span className='flex items-center text-gray-600'>
										<Icon icon='HeroCloudArrowUp' className='mr-1 h-3 w-3' />
										Cloud & Migración
									</span>
								...
								<div className='flex justify-between'>
									<span className='flex items-center text-gray-600'>
										<Icon icon='HeroCodeBracket' className='mr-1 h-3 w-3' />
										Desarrollo
									</span>
								...
								<div className='flex justify-between'>
									<span className='flex items-center text-gray-600'>
										<Icon icon='HeroUsers' className='mr-1 h-3 w-3' />
										Consultoría
									</span>
						...
						<div className='space-y-3'>
							<Button
								...
								<Icon icon='HeroServerStack' className='mr-2 h-4 w-4' />
							...
							<Button
								...
								size='sm'
								className='w-full justify-start border-blue-200 text-blue-700 hover:bg-blue-50'>
								<Icon icon='HeroCloudArrowUp' className='mr-2 h-4 w-4' />
								Panel Cloud AWS
							</Button>
						...
						<div className='border-t border-blue-200 pt-4'>
							<div className='text-center'>
								<p className='mb-2 text-xs text-gray-600'>Certificaciones</p>
						...
						<div className='border-t border-blue-200 pt-4'>
							...
							<Button
								variant='outline'
								size='sm'
								className='w-full border-blue-200 text-xs text-blue-600 hover:bg-blue-50'
