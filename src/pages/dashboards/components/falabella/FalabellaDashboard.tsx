...
import FalabellaBackendService, {
	Product,
	InventorySummary,
	BestSellingProduct,
} from '@/services/falabellaApi.service';
		...
		<div className='space-y-6 py-6'>
				...
				<Card className='border-red-200 bg-red-50 dark:bg-red-900/20'>
					<CardBody className='p-4'>
						<div className='flex items-center space-x-2 text-red-700 dark:text-red-400'>
							<Icon icon='HeroExclamationTriangle' className='h-5 w-5' />
							<span>{error}</span>
						</div>
					</CardBody>
				</Card>
			...
			<div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4'>
				<Card className='bg-gradient-to-br from-red-500 to-red-600 text-white shadow-lg'>
					<CardBody className='p-6'>
						<div className='flex items-center justify-between'>
							<div>
								<p className='text-sm font-medium text-red-100'>Total Productos</p>
							...
							<div className='rounded-lg bg-white/20 p-3'>
								<Icon icon='HeroCubeTransparent' className='h-8 w-8 text-white' />
							</div>
						</div>
					</CardBody>
				</Card>
				...
				<Card className='bg-gradient-to-br from-red-600 to-red-700 text-white shadow-lg'>
					<CardBody className='p-6'>
						<div className='flex items-center justify-between'>
							<div>
								<p className='text-sm font-medium text-red-100'>Valor Inventario</p>
								<p className='text-3xl font-bold'>
				...
				<Card className='bg-gradient-to-br from-orange-500 to-red-500 text-white shadow-lg'>
					<CardBody className='p-6'>
						<div className='flex items-center justify-between'>
							<div>
								<p className='text-sm font-medium text-orange-100'>Stock Bajo</p>
								<p className='text-3xl font-bold'>
				...
				<Card className='bg-gradient-to-br from-red-700 to-red-800 text-white shadow-lg'>
					<CardBody className='p-6'>
						<div className='flex items-center justify-between'>
							...
							<div className='rounded-lg bg-white/20 p-3'>
								<Icon icon='HeroXCircle' className='h-8 w-8 text-white' />
							</div>
						</div>
					</CardBody>
				</Card>
			...
			<div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
				...
				<Card className='col-span-1 shadow-lg'>
					<CardHeader className='rounded-t-lg bg-gradient-to-r from-red-500 to-red-600 text-white'>
						<div className='flex items-center justify-between'>
					...
					<CardBody className='max-h-96 overflow-y-auto p-0'>
						{loading ? (
							<div className='p-6 text-center'>
								<Icon
									icon='HeroArrowPath'
									className='mx-auto mb-2 h-6 w-6 animate-spin text-red-500'
								/>
							...
							lowStockProducts.map((product) => (
								<div
									...
									className='border-b border-gray-100 p-4 transition-colors hover:bg-red-50'>
									<div className='flex items-center justify-between'>
				...
				<Card className='col-span-1 shadow-lg'>
					<CardHeader className='rounded-t-lg bg-gradient-to-r from-red-600 to-red-700 text-white'>
						<div className='flex items-center justify-between'>
							<h3 className='flex items-center text-lg font-semibold'>
							...
							bestSellingProducts.slice(0, 5).map((item, index) => (
								<div
									...
									<div className='flex items-center justify-between'>
										...
										<div className='ml-4 text-right'>
											<Badge className='bg-red-100 font-semibold text-red-800'>
				...
				{/* Panel de Control */}
				<Card className='col-span-1 shadow-lg'>
					<CardHeader className='rounded-t-lg bg-gradient-to-r from-red-700 to-red-800 text-white'>
						<h3 className='flex items-center text-lg font-semibold'>
