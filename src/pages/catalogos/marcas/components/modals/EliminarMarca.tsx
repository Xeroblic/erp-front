...
const EliminarMarca: React.FC<EliminarMarcaProps> = ({
	isOpen,
	setIsOpen,
	brand,
	onConfirm,
					...
					<div className='rounded-lg bg-red-50 p-4'>
						<div className='flex items-start'>
							...
							<div className='space-y-2 text-sm text-red-700'>
								<p>
									Estas seguro de eliminar la marca <strong>{brand.name}</strong>?
								</p>
								{brand.code && (
									<p>
										Codigo:{' '}
								...
								{brand.products_count > 0 && (
									<p className='font-semibold text-red-800'>
										La marca tiene {brand.products_count} productos asociados.
		...
		<ModalFooter>
			<div className='flex justify-end space-x-3'>
				...
				<Button
					color='red'
					onClick={onConfirm}
					isDisable={!brand || brand.products_count > 0 || isLoading}>
					{isLoading
						? 'Eliminando...'
						: brand && brand.products_count > 0
