...
const EditarCategoria: React.FC<EditarCategoriaProps> = ({ isOpen, setIsOpen, category, onSubmit, categories }) => {
      ...
      <ModalHeader>
        <div className='flex items-center space-x-3'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-600'>Actualiza la información de la categoría</p>
          </div>
        </div>
      </ModalHeader>
      <ModalBody>
        {category && (
          <form id='editCategoryForm' className='space-y-4' onSubmit={onSubmit}>
            ...
            <div>
              ...
              <Textarea id='edit-description' name='description' rows={3} defaultValue={category.description} />
            </div>
