...
const CrearCategoria: React.FC<CrearCategoriaProps> = ({ isOpen, setIsOpen, onSubmit, categories }) => {
        ...
        <form id='createCategoryForm' className='space-y-4' onSubmit={onSubmit}>
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            <div>
              ...
              <Input id='create-name' name='name' type='text' placeholder='Ej: Electrónica' required />
            </div>
            <div>
          ...
          <div>
            ...
            <Textarea id='create-description' name='description' rows={3} placeholder='Descripción de la categoría...' />
          </div>
