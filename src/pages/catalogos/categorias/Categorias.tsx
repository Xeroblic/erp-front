  ...
  return (
    <PageWrapper name="categorias-admin">
        ...
        <SubheaderLeft>
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Organiza tus productos por categorias</p>
            </div>
          </div>
        </SubheaderLeft>
        <SubheaderRight>
      ...
      <EliminarCategoria
        ...
        isLoading={deleting}
      />
      <DetalleCategoria isOpen={viewOpen} setIsOpen={setViewOpen} category={selected} onEdit={handleEdit} />
    </PageWrapper>
  );
};
