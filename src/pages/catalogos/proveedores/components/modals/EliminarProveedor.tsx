...
const EliminarProveedor: React.FC<EliminarProveedorProps> = ({
	...
	const hasAssociations = Boolean(supplier && (supplier.customer_suppliers_count ?? 0) > 0);
							...
							<div className='rounded-md border border-red-200 bg-red-50 p-3 text-red-700'>
								<div className='flex items-start'>
									...
									<div>
										...
										<p>
											Este proveedor tiene {supplier.customer_suppliers_count}{' '}
											cliente(s) asociado(s). Debes desasociar estos clientes
											antes de continuar.
										</p>
									</div>
								</div>
							...
							<div className='rounded-md border border-yellow-200 bg-yellow-50 p-3 text-yellow-700'>
								<div className='flex items-start'>
									...
									<div>
										...
										<p>
											Esta acción no se puede deshacer. El proveedor será
			...
			<ModalFooter>
				<div className='flex justify-end space-x-3'>
					...
					<Button
						color='red'
						onClick={onConfirm}
						isDisable={!supplier || hasAssociations}>
						Eliminar Proveedor
					</Button>
				</div>
			</ModalFooter>
