			...
			<main className='relative flex min-h-screen flex-col overflow-hidden bg-zinc-50 dark:bg-zinc-950 font-sans'>
				...
				<div className='relative z-10 flex flex-1 items-center justify-center p-4 sm:p-6 lg:p-8'>
					<div className='w-full max-w-md animate-fade-in'>
						{!checkoutResult ? (
							<Card className='overflow-hidden border-zinc-200/60 bg-white/90 shadow-2xl shadow-zinc-200/50 backdrop-blur-xl dark:border-zinc-800 dark:bg-zinc-900/90'>
								<div className='relative overflow-hidden bg-blue-600 px-6 py-10 text-center text-white'>
									...
									<h2 className='relative z-10 text-2xl font-bold'>Retira tu Equipo</h2>
								...
								<CardBody className='p-8'>
									<form onSubmit={formik.handleSubmit} className='space-y-6'>
										<div className='space-y-2'>
											<Label htmlFor='withdrawal_keyword' className='text-zinc-500 font-semibold uppercase text-[10px] tracking-widest ml-1'>
												Palabra Clave
											</Label>
											<FieldWrap
										...
										<Button
											type='submit'
											color='blue'
											className='w-full py-4 text-lg font-bold shadow-xl shadow-blue-500/20 active:scale-[0.98] transition-transform rounded-xl'
											isDisable={isSubmittingCheckOut || !formik.values.withdrawal_keyword}
											icon={isSubmittingCheckOut ? 'HeroArrowPath' : 'HeroUnlock'}>
											{isSubmittingCheckOut ? 'Validando...' : 'Verificar y Abrir'}
										</Button>
