...
export const NOTEBOOK_HINTS: Record<string, string> = {
	...
	has_second_battery: 'Marca si el equipo trae una segunda batería',
	second_battery_status: 'Estado de la segunda batería; mismas opciones que la principal',
	second_battery_percentage: 'Porcentaje de salud de la segunda batería (0-100)',
	second_battery_condition: 'Condición/health informado de la segunda batería',
...
export const NOTEBOOK_PLACEHOLDERS: Record<string, string> = {
	...
	second_battery_percentage: 'Ej: 85',
	second_battery_condition: 'Ej: 85%, Normal, Service',
