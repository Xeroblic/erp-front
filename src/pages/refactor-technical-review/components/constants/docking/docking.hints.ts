export const DOCKING_HINTS = {
	...
	general_condition:
		'Estado general del equipo considerando estética y funcionamiento global',
...
export const DOCKING_PLACEHOLDERS = {
	...
	model: 'Ej: WD19TB, ThinkPad Pro...',
	line: 'Ej: Latitude, ThinkPad...',
	observations: 'Ej: Carcasa con rayón leve...',
} as const;
