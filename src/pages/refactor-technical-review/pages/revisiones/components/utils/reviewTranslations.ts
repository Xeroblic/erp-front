...
import {
	isHardwareAbsent,
	HARDWARE_ABSENT_LABEL,
} from '@/pages/refactor-technical-review/components/constants/shared/hardware.sentinels';
...
export const extractValue = (field: unknown): string => {
	if (!field) return 'N/A';
	if (isHardwareAbsent(field)) return HARDWARE_ABSENT_LABEL;
