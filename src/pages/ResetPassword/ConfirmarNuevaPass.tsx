							...
							<div className='mx-auto max-w-md'>
								<div className='mb-6 space-y-2 text-center'>
									...
									<p className='text-emerald-900/80'>
										Crea una contraseña segura y confírmala para completar el
										proceso.
									</p>
								</div>
								...
								<form
									...
									<div>
										...
										<div className='relative'>
											...
											<button
												...
												className='absolute inset-y-0 right-2 my-1.5 rounded-md px-2 hover:bg-emerald-50'>
												<Icon
									...
									<p className='text-xs text-emerald-900/70'>
										Consejo: usa al menos 8 caracteres. Mezcla letras y números
