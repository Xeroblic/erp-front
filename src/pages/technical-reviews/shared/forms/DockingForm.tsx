...
import { GENERAL_CONDITION_OPTIONS, COVER_CONDITION_OPTIONS } from '../constants/formOptions';
				...
				return (
					<motion.div
						...
						<div className='space-y-6'>
							...
							<div className='rounded-xl border border-gray-200 bg-gray-50 p-4 dark:bg-gray-900/10'>
								<YesNoSelector
