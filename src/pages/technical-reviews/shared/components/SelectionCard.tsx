...
export const SelectionCard: React.FC<SelectionCardProps> = ({
	...
	const colorStyles = {
		...
		gray: isSelected
			...
			: 'bg-white border-gray-300 text-gray-700 hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400',
	};
	...
	return (
		<div
			...
			className={`cursor-pointer rounded-xl border-2 p-3 text-center transition-all duration-200 ${
				isSelected ? 'z-10 scale-105' : 'scale-100'
			} ${colorStyles[color]} flex min-h-[70px] flex-col items-center justify-center gap-2 ${className}`}>
