...
const Aside: FC<IAsideProps> = ({ children, className, ...rest }) => {
	...
	return (
		<aside
			...
			className={classNames(
				'peer fixed bottom-0 top-0 z-30 md:z-20 flex flex-col border-zinc-300/25 bg-white py-6 ltr:border-r rtl:border-l dark:border-zinc-800/50 dark:bg-zinc-900 dark:text-white',
