...
const Aside: FC<IAsideProps> = ({ children, className, ...rest }) => {
	...
	return (
		<aside
			...
			className={classNames(
				'peer group/aside fixed bottom-0 top-0 z-30 md:z-20 flex flex-col border-zinc-600/20 bg-gray-300/95 py-6 ltr:border-r rtl:border-l dark:border-zinc-800/50 dark:bg-zinc-900 dark:text-white',
