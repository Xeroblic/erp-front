	...
	return (
		<span
			className={classNames(
				...
				'bg-gray-200 dark:border-none dark:bg-zinc-800',
				{ 'me-3': asideStatus },
			)}>
			<Icon
	...
	return (
		<Tooltip text={asideStatus ? '' : t(children)} placement='right'>
			<li
				...
				className={classNames(
					'mt-4 list-none overflow-hidden truncate whitespace-nowrap px-3 py-1.5 text-sm font-semibold uppercase text-zinc-700 dark:text-zinc-100', // Agregué un margen top para respirar
					className,
				)}
				{...rest}>
				<motion.div
	...
	return (
		<Tooltip text={asideStatus ? '' : t(text)} placement='right'>
			<motion.li
				...
				className={classNames(
					'mt-auto flex list-none items-center overflow-hidden whitespace-nowrap', // mt-auto por si quieres que vaya al fondo
					className,
				)}
				{...(rest as any)}>
				{to ? (
