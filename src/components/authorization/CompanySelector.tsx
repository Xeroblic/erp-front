		...
		<Modal isOpen={isOpen} setIsOpen={onClose} size='lg'>
			<ModalHeader>
				<div className='flex items-center gap-2'>
					<Icon icon='HeroBuildingOffice2' className='h-5 w-5' />
					Seleccionar Empresa
				</div>
			</ModalHeader>
				...
				<div className='space-y-4'>
					{currentCompany && (
						<div className='rounded-lg bg-blue-50 p-4'>
							<div className='mb-2 flex items-center gap-2'>
								<Icon icon='HeroCheckCircle' className='h-5 w-5 text-blue-600' />
					...
					{user?.authority?.includes('super-admin') && (
						<div className='rounded-lg bg-amber-50 p-3'>
							<div className='flex items-center gap-2'>
								<Icon icon='HeroShieldCheck' className='h-4 w-4 text-amber-600' />
			...
			<ModalFooter>
				...
				<Button
					...
					isDisable={
						!selectedCompanyId || selectedCompanyId === currentCompany?.id?.toString()
					}>
					{selectedCompanyId === currentCompany?.id?.toString()
						? 'Empresa Actual'
						: 'Cambiar Empresa'}
				</Button>
			</ModalFooter>
