...
description: Use when assembling final production code from specs provided by other agents. Use ONLY when integrating types, logic hooks, and UI components into a complete file, or when the user asks for final code assembly or integration.
---
