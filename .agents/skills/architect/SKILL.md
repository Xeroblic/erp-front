---
name: architect
description: Use when designing module architecture, planning file structure, delegating tasks to other agents (Full_TS, Full_React, UI_UX, Dev_Implementador, Tester_QA), or reviewing technical decisions for Zentria ERP. Use ONLY when the user asks for architecture, module design, tech lead guidance, or task delegation.
---
