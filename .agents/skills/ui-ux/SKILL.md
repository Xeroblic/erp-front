---
name: ui-ux
description: Use when creating React UI components, visual layouts, or working with the Zentria Design System (PageWrapper, Subheader, Container, Card, Modal, Formik-bound inputs). Use ONLY when the user asks for UI, visual components, JSX, design system compliance, or frontend layout.
---
